...
> 一套源自一级市场投资实践、以证据纪律为核心的公司研究工作流：从零散材料出发，更快看懂公司，再形成可检验、可更新的判断。

## 30 秒看懂

做公司研究时，真正困难的不只是信息少，而是信息很多，却难以迅速抓住什么最重要：公司到底在解决什么问题，行业和客户为什么需要它，产品与商业模式为什么可能成立，核心驱动是否真实，以及哪些关键判断仍只是公司口径或研究假设。AI 很擅长总结材料，但“读完了”不等于“看懂了”。

这套仓库把理解与判断过程拆成六个可复用的 Skills：先界定材料能支持什么，再识别业务本质与核心逻辑，形成结构化候选判断，用证据、最强反方和证伪挑战它，决定下一步最值得验证什么，并在新信息到来时区分材料变化、证据变化和判断变化。明确的输入要求、输出结构、证据语义和质量检查，使它不同于普通 Prompt Collection。

AI 可以帮助收集和挑战证据、寻找反方、安排尽调优先级、保留判断历史并提高可复核性。人仍负责定义问题、判断证据是否足够、处理例外、决定是否采纳判断，并承担最终的专业或投资决策。

这套方法起源于一级市场科技投资，也可自然用于投行前期研究、公司与行业研究、企业战略、交易准备、尽调团队，以及准备接受投资人尽调的创业者；核心仍是有证据纪律的投资式公司研究，不是万能商业分析框架。所有示例均为虚构数据。
...
- **外部研究与证据构建（External Research & Evidence Build）**：若后续验证成立，可增强无内部材料和公开研究场景，从研究问题走到来源发现、交叉验证、证据构建和停止条件。
- **后续轮与交易研判（Follow-on / Transaction Review）**：若后续验证成立，可增强融资、交易准备、投行和后续轮场景，重点区分“公司是否仍值得看好”和“当前交易条件是否值得参与”。
...
- 本仓库来自 AI InvestOS 实践，但可以独立使用；不包含私有业务代码、模型配置、真实项目资料或项目状态。
